...
var taylorSwift1 = StudioAlbum1(name: "Taylor Swift", studio: "The Castles Studios")
var fearless1 = StudioAlbum1(name: "Speak Now", studio: "Aimeeland Studio")
var iTunesLive1 = LiveAlbum1(name: "iTunes Live from SoHo", location: "New York")

var allAlbums1: [Album1] = [taylorSwift1, fearless1, iTunesLive1]
...
for album in allAlbums1 {
    let studioAlbum = album as? StudioAlbum1
}
...
for album in allAlbums1 {
    ...
    if let studioAlbum = album as? StudioAlbum1 {
        print(studioAlbum.studio)
    } else if let liveAlbum = album as? LiveAlbum1 {
...
var taylorSwift2 = StudioAlbum1(name: "Taylor Swift", studio: "The Castles Studios")
var fearless2 = StudioAlbum1(name: "Speak Now", studio: "Aimeeland Studio")

var allAlbums2: [Album1] = [taylorSwift2, fearless2]
